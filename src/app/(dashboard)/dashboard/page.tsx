        ...
        {!hasAccess && (
          <div style={{ background:"#1a1a18", borderRadius:14, padding:"28px 32px", marginBottom:36, display:"flex", alignItems:"center", justifyContent:"space-between", gap:20 }}>
            ...
            <div style={{ display:"flex", gap:10, flexShrink:0 }}>
              <Link href="#" style={{ background:"#c8923a", color:"#fff", padding:"12px 24px", borderRadius:8, fontSize:13, fontWeight:600, textDecoration:"none", whiteSpace:"nowrap" }}>Full Access — $29/mo</Link>
              <Link href="#" style={{ background:"rgba(255,255,255,.08)", color:"#fff", padding:"12px 24px", borderRadius:8, fontSize:13, fontWeight:500, textDecoration:"none", whiteSpace:"nowrap" }}>Lifetime — $149</Link>
            </div>
          </div>
        )}
