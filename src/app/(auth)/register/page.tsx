    ...
    <div style={{ minHeight:"100vh", background:"#FAFAF8", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:"40px 20px", fontFamily:"'DM Sans',sans-serif" }}>
      ...
      <div style={{ width:"100%", maxWidth:420, background:"#fff", border:"1px solid #e8e0d0", borderRadius:16, overflow:"hidden", boxShadow:"0 8px 40px rgba(0,0,0,0.08)" }}>
        ...
        <div style={{ background:"#1a1a18", padding:"28px 32px" }}>
          <h1 className="serif" style={{ fontSize:28, fontWeight:700, color:"#fff", marginBottom:4 }}>Create your account</h1>
          <p style={{ fontSize:13, color:"rgba(255,255,255,.5)" }}>Get instant access to 250+ business templates</p>
        </div>
        ...
        <div style={{ padding:"28px 32px" }}>
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom:16 }}>
              <label style={{ display:"block", fontSize:12, fontWeight:600, color:"#7a7060", marginBottom:6, letterSpacing:".3px" }}>Full name</label>
          ...
          <p style={{ textAlign:"center", fontSize:13, color:"#7a7060" }}>
            ...
            <Link href="/login" style={{ color:"#c8923a", fontWeight:600, textDecoration:"none" }}>Sign in</Link>
          </p>
        </div>
      </div>
      ...
      <div style={{ display:"flex", gap:24, marginTop:24, flexWrap:"wrap", justifyContent:"center" }}>
        {["✓ Instant download", "✓ Cancel anytime", "✓ Free updates forever"].map(t => (
          <span key={t} style={{ fontSize:11, color:"#7a7060" }}>{t}</span>
        ))}
      </div>
