    ...
    <div className="min-h-screen bg-[#080C14] flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[#0F1623] border border-white/[0.07] rounded-2xl p-8">
          ...
          <p className="text-[#6B7A99] text-[13px] mb-7">Sign in to your account</p>
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="••••••••" required className="w-full px-4 py-2.5 rounded-xl border border-white/[0.07] text-white text-[14px]"/>
            </div>
          ...
          <p className="text-center text-[13px] text-[#6B7A99] mt-6">
            ...
            <Link href="/register" className="text-[#5B93FF] hover:text-white transition-colors">Create one free</Link>
          </p>
        </div>
